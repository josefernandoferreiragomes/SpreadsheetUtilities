...
$OutputPath = Join-Path $ProjectDir "Services\Generated\AuthApiClient.cs"
...
nswag openapi2csclient /input:$SpecPath /output:$OutputPath /namespace:SpreadsheetUtility.UI.Web.Services.Generated /classname:SpreadsheetUtilitiesAuthApiClient
